    ...
    Public Class Paciente
        ...
        Public Shared Function getPaciente(inRut As Integer, strPasaporte As String, ByRef NoData As Boolean) As Paciente
            ...
            Try
                ...
                Dim cmd As OleDbCommand = New OleDbCommand("Kaplan.Kaplan.BuscarPersona", conn)
        ...
        Public Function ModificarPaciente() As Boolean
            Dim conn As OleDbConnection = New OleDbConnection(ConfigurationManager.ConnectionStrings("ConexionKaplan").ConnectionString)
            Dim cmd As OleDbCommand = New OleDbCommand("Kaplan.Kaplan.ModificarPacienteFicha", conn)
            cmd.CommandType = CommandType.StoredProcedure
